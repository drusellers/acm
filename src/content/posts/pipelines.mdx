...
excerpt:
  ...
  tease: "A practical walkthrough of indexing pipelines, from change capture and denormalization to canonicalization and freshness."
pipeline: |
  flowchart LR
...
<Mermaid content={frontmatter.pipeline} />
...
<Mermaid content={frontmatter.expanded_pipeline} />
